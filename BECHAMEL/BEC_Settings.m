...
%% Graphics defaults
    ...
    %Colors 
        ...
        %Background colors
            ...
            exp_settings.background.task = exp_settings.colors.grey;    
         %Font colors
...
%% Choice screen configuration
    ...
    % Timings
        %exp_settings.timings.min_resp_time = 1; %[s] before ppl can respond
        ...
        exp_settings.timings.min_resp_time = 0.7; 
        %exp_settings.timings.max_resp_time = 3.25; %[s] timeout time, set Inf if there is no timeout. When timeout is reached, the choice and RT will be set to NaN.
