function [ns, eyeTrackdata, log] = NS_task_nswitch_EEG_v01(pr, tm, condition, sessnum, blocknum, ISI, switches, eyeTrackdata)
...
searchstring = sprintf([pr.path.nswitch 'nswitch_%s_%s_sess_%03i*.mat'], condition, pr.fname, sessnum);
...
savewhere    = sprintf([pr.path.nswitch 'nswitch_%s_%s_sess_%03i.mat'], condition, pr.fname, sessnum);
...
ins = {'instructions/Slide1.TIF', 'instructions/Slide2.TIF'};
...
%[ns1, eyeTrackdata, log] = NS_present_nswitch_v03(pr.group, pr.ptb, log, colortype, indexletter, ISI, eyeTrackdata);
[ns1, eyeTrackdata, log] = NS_present_nswitch_EEG_v01(pr.group, pr.ptb, log, colortype, indexletter, ISI, eyeTrackdata);
